...
class App extends Component<Props, State> {
  ...
  getImage(currentUser: IUser) {
    if(!currentUser.img_url) {
      return "/profile-picture.webp"
    } else {
  ...
  <header>
    ...
    >
      ...
      {currentUser && (
        ...
        arrowIcon={false}
        inline={true}
        label={<Avatar alt="User settings" img={this.getImage(currentUser)} rounded={true}/>}
      >
        <Dropdown.Header>
      ...
      {!currentUser && (
        <div className="self-center flex dark:text-white pr-5">
        <a
        href={"/login"}
      >
        Login
